 ...
 * 这一章只写了「在项目库里点一个」。一台刚装好的机器上项目库是空的，
 * 这三页却在叫人去那儿点一个——而初始化那一页 2026-09-14 删了，"第一次
 * 打开该干什么"现在全靠这句话。
 *
 * 底下还顺带钉住同一族的另一句：「还没选到某一章」下面那半句。一章都没有
 * 的时候「顶上挑一章」同样办不到——那时候顶栏那个下拉是灰的，里面只有一行
 * 「还没有章」。新项目最常撞见的就是这个状态（故事写完、还没落成章节）。
 */
