 ...
 * 设定页会开。而要跟着"跑完了"刷新的地方在别的页上：
 *
 *     项目库那条栏     卡片上的「1/2 章已出片」
 *     这一章那排标签   「镜头 12 · 差 3 首帧」「成片 1」
 *     设定页那行标签   「角色 12 · 缺 3」「场景 8 · 缺 2」
 *     成片那一页       片单本身
 *
...
const EDGES = [
  ...
  // 成片只有出片那个槽会出，写全片跑完不该让这一页白拉一趟
  ['views/episode/EpFilm.vue', "['run']"],
  // 镜头页：批量补分镜就在这一页上按，而它跑在"写"那个槽上
