 ...
 *
 * **2026-09-12 起按四段显示。** 一章是四拍按秒排的（开场钩子 / 冲突
 * 推进 / 情绪回报 / 章尾留扣），时长是从剧本里长出来的。以前这里是一列平的
 * 拍子，60 秒的一章写成 13 秒也看不出哪儿少了——现在每段底下有"几句、约几秒"，
...
// 那四个（开场钩子/冲突推进/情绪回报/章尾留扣），而引擎会 `random_shape()`
